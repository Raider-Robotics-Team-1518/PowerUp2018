...
public class RobotMap {
    ...
    public static void init() {
    	...
    	solenoid0 = new Solenoid(1);
    	solenoid1 = new Solenoid(2);
    	solenoid2 = new Solenoid(3);
    	solenoid3 = new Solenoid(4);
    	solenoid4 = new Solenoid(5);
    	solenoid5 = new Solenoid(6);
    	...
    	dio9 = new DigitalOutput(9);
    		...
    		//Limit Switches
    	TopBoxSwitch = new DigitalInput(4);
    	BottomBoxSwitch = new DigitalInput(5);
    	TopClimbSwitch = new DigitalInput(6);
    	BottomClimbSwitch = new DigitalInput(7);
